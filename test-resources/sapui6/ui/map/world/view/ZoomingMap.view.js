...
sap.ui.jsview("view.ZoomingMap", {
    ...
    selectCountry : function(world, countryCode, countryName){
      ...
      var content = null;
      if(sap.ui.Device.browser.msie) content = this.createCountryContent2(countryCode, countryName);
      else content = this.createCountryContent(countryCode, countryName);
    ...
    createCountryContent2 : function(countryCode, countryName){
      var oToolbar = new sap.ui.commons.Toolbar();
      oToolbar.addRightItem(new sap.ui.core.Icon({src:"sap-icon://decline", press:function(){countryPopup.close();}}));
