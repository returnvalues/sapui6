sap.ui.jsview("view.ContextMenu", {
    createContent : function (oController) {
        ...
        var table = new sapui6.ui.table.Table({
            ...
            button : [
                ...
                new sap.ui.commons.Button({text:"Print", style: sap.ui.commons.ButtonStyle.Emph, press:function(){
                    table.print('Grid Title');
                }})
            ]
        });
