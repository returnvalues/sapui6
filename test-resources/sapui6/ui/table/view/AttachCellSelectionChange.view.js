sap.ui.jsview("view.AttachCellSelectionChange", {
    createContent : function (oController) {
        ...
        var table = new sapui6.ui.table.Table({
            title: "Table - CellSelectionChange",
            width:"100%", 
            height:"730px",
            columns:columns,
            margin: "10px",
            ...
            cellSelectionChange : function(data){
                sap.ui.commons.MessageBox.alert("rowIndex : " + data.getParameter("rowIndex") + ", cellIndex : " + data.getParameter("cellIndex") + ", cellData : " + data.getParameter("cellData"));
            }, 
            button : [
