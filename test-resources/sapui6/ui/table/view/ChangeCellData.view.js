sap.ui.jsview("view.ChangeCellData", {
    createContent : function (oController) {
        ...
        var table = new sapui6.ui.table.Table({
            ...
            margin: "10px",
            resize: true,
            title: "Table - Change Cell Data - Row Index:0, Cell Index:0",
            button : [
                ...
                new sap.ui.commons.Button({text:"Change Cell", style: sap.ui.commons.ButtonStyle.Reject, press:function(){table.getModel("t").setProperty("/data/0/company","ABC")}})
            ]
        });
