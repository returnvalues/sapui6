sap.ui.jsview("view.BigDataTable", {
    createContent : function (oController) {
        jQuery.sap.require("sapui6.ui.table.BigDataTable");
        ...
        var table = new sapui6.ui.table.BigDataTable({
            ...
            button : [
                new sap.ui.commons.Button({text:"Search", style: sap.ui.commons.ButtonStyle.Emph, press:function(){
                    ...
                    jQuery.sap.delayedCall(1000, oModel, function() {
                        oModel.loadData("view/BigData.model.json", "", false);
                    });
