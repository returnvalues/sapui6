sap.ui.jsview("view.Layout5i", {

	createContent : function (oController) {
		jQuery.sap.require("sapui6.ui.layout.Layout5I");
        var oLayout = new sapui6.ui.layout.Layout5I({
            width : "100%",
            leftWidth : "33%",
            middleWidth : "34%",
            rightWidth : "33%"
        ...
        oLayout.addContent(c.data("position","C")); // .data("position","C") is middle-middle side.
        oLayout.addContent(d.data("position","D")); // .data("position","D") is middle-right side.
