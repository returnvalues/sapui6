sap.ui.jsview("view.Layout3t", {

	createContent : function (oController) {
		jQuery.sap.require("sapui6.ui.layout.Layout3T");
        var oLayout = new sapui6.ui.layout.Layout3T({
            width : "100%",
            leftWidth : "50%",
            rightWidth : "50%",
            topHeight : "300px"
        ...
        oLayout.addContent(c.data("position","C")); // .data("position","C") is bottom-right side.
