...
sapui6.ui.commons.NumberFormatField.prototype.bindValue = function(sPath){
	this.bindProperty("value",{path:sPath,type:this.getType()});
};

sapui6.ui.commons.NumberFormatField.prototype.getParseValue = function(){
	return this.getBindingInfo("value").binding.oValue;
};

sapui6.ui.commons.NumberFormatField.prototype.getType = function(){
...
sapui6.ui.commons.NumberFormatField.prototype._countChar = function(sStr, sChar){
	var cnt = 0;
