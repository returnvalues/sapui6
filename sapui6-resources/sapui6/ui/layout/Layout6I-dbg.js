jQuery.sap.declare("sapui6.ui.layout.Layout6I");

sap.ui.core.Control.extend("sapui6.ui.layout.Layout6I", {  
    metadata : {     
    ...
    renderer : function(oRm, oControl) {   
        ...
        oRm.write('<tr>');
        oRm.write('<td colspan="4" style="vertical-align:top;padding:0px 0px 0px 0px;">');
        ...
        for(var i=0 ; i<length ; i++){
            ...
            oRm.write('>');
            if(content[i].data("position") == "E") oRm.renderControl(content[i]);
            oRm.write('</div>');
        }
        oRm.write('</td>');
        ...
        for(var i=0 ; i<length ; i++){
            ...
            oRm.write('>');
            if(content[i].data("position") == "F") oRm.renderControl(content[i]);
            oRm.write('</div>');
        }
        oRm.write('</td>');
        oRm.write('</tr>');
