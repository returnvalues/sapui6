jQuery.sap.declare("sapui6.ui.layout.InlineForm");
jQuery.sap.require("sap.ui.core.Control");

sap.ui.core.Control.extend("sapui6.ui.layout.InlineForm", { 
    metadata : {     
    ...
    onBeforeRendering : function(){
  	...
  	renderer : function(oRm, oControl){
		...
		oRm.write("<div");
		oRm.writeAttribute("id", oControl.getId()+"-inline-form");
		oRm.addClass("inlineForm");
		oRm.writeClasses();
		...
		for(var i=0 ; i<length ; i++){
			...
			if(item["side"] == undefined || item["side"] == "left"){
				if(item["label"] != undefined){
					oRm.write("<span");
					oRm.addStyle("color",oControl.getTextColor());
					oRm.addStyle("font-size",oControl.getFontSize());
					if(i>0) oRm.addStyle("margin-left","10px");
					oRm.addStyle("margin-right","10px");
					if(oControl.getLabelBold()) oRm.addStyle("font-weight", "bold");
					oRm.writeStyles();
					oRm.write(">");
...
sapui6.ui.layout.InlineForm.prototype.resizeLayout = function(widthRatio){
...
sapui6.ui.layout.InlineForm.prototype.set = function(oSettings){
