(function(){
    ...
    sap.ui.jsfragment("fragments.valuehelp.payer", {
        createContent : function(oController) {
            var oLayout = new sap.ui.layout.VerticalLayout({width:"100%"});

            var oDialog = new sap.ui.commons.Dialog({title:"Payer",width:"540px",height:"530px"});
        ...
        createSearchField : function(oController){
            ...
            var oSearch = new sap.ui.commons.Button({text:"Search", height:"28px", style:sap.ui.commons.ButtonStyle.Emph, press:function(){
                ...
                oModel.loadData("../fragments/valuehelp/payer.model.json",params,false);
            }});
