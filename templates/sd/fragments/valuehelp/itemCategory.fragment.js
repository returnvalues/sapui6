(function(){
    ...
    sap.ui.jsfragment("fragments.sap.sd.valuehelp.itemCategory", {
        createContent : function(oController) {
            var oLayout = new sap.ui.layout.VerticalLayout({width:"100%"});
            oLayout.addContent(this.createItemField(oController));  

            var oDialog = new sap.ui.commons.Dialog({title:"Item Category",width:"430px",height:"540px"});
        ...
        createItemField : function(oController){
            ...
            oModel.loadData("fragments/sap/sd/valuehelp/itemCategory.model.json","",false);
