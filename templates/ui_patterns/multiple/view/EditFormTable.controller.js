...
(function(){
	...
	sap.ui.controller("view.EditFormTable", {
		onInit: function() {
			_Controller = this;
	      	_View = this.getView();
	  	},
	 	...
	 	onBeforeRendering: function() {
			...
			dl.load("model/EditFormTable.model.json","",false);
	  	},
		...
		openValueHelpForTable: function(oEvent){
			...
			var _tDialog = sap.ui.jsfragment("fragments.valuehelp.code");
			_tDialog.attachClosed(function(){
				tableModel.setProperty(oBindingInfo.path+"/" + oTable.getSelectedRowIndex() + "/"+oValueHelp.getBindingInfo("value").binding.sPath, _tDialog.data("code"));
			});
