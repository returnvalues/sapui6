sap.ui.jsview("view.TreeTabView", {
    getControllerName : function() {
        return "view.TreeTabView";
    },
    ...
    createTitle : function(oController){
        ...
        return new sap.ui.core.HTML({content:'<div style="margin:0px 0px 5px 0px;padding-left: 5px;color:' + titleColor + ';font-weight:bold;font-size:' + tileFontSize + ';border-left:5px solid ' + strongColor + ';">Tree Form & Tabs</div>'});
    },
    ...
    createDetail : function(oController){
        ...
        var oTabStrip = new sapui6.ui.commons.TabStrip(this.getId()+"-tab-right",{
            width:"780px",
            height:"600px",
            margin:"10px",
            marginTop:"0px"
