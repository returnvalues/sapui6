sap.ui.jsview("view.ListItemStatus", {

    getControllerName : function() {
        return "view.ListItemStatus";
    },
    ...
    createSearchField : function(oController){
        ...
        var oBorderedForm = new sapui6.ui.layout.BorderedForm({
                ...
                title : "Multi Edit - Change Line Item Status",
                button : [
                        new sap.ui.commons.Button({text:"Search", style:sap.ui.commons.ButtonStyle.Emph, press:oController.doSearch}),
                        new sap.ui.commons.Button(this.getId()+"-btn-approve",{text:"Approve", style:sap.ui.commons.ButtonStyle.Emph, enabled:false, press:oController.doApprove}),
                        new sap.ui.commons.Button(this.getId()+"-btn-reject",{text:"Reject", style:sap.ui.commons.ButtonStyle.Emph, enabled:false, press:oController.doReject})
                ]
        });
    ...
    createTable : function(oController){
        ...
        var table = new sapui6.ui.table.Table(this.getId()+"-table",{
            ...
            checkedSelection: oController.checkedRadio
        });
