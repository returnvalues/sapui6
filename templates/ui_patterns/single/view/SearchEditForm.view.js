sap.ui.jsview("view.SearchEditForm", {

    getControllerName : function() {
        return "view.SearchEditForm";
    },
    ...
    createForm : function(oController){
        ...
        var oBorderedForm = new sapui6.ui.layout.BorderedForm(this.getId()+"-form-edit",{
            columns : 4,
            width : "100%",
            marginTop : "10px",
            labelBackgroundColor : "#eef7ff",
